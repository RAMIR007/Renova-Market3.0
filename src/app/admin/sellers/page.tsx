    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-gray-900">Vendedores</h1>
                    <p className="text-gray-500 mt-1">Gestiona tu equipo de ventas y códigos de referido.</p>
                </div>
                <button
            ...
            {isCreating && (
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 animate-in slide-in-from-top-4">
                    <h3 className="font-semibold mb-4">Registrar Nuevo Vendedor</h3>
