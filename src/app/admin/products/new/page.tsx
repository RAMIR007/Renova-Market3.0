                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            <input
                                ...
                                name="image"
                                placeholder="https://..."
                                className="flex-1 px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-black focus:outline-none"
                            />
                        </div>
                        <p className="text-xs text-gray-500 mt-2 flex items-center gap-1">
                            <UploadCloud size={14} />
                            Próximamente: Carga directa de imágenes.
                        </p>
                    </div>
                </div>
